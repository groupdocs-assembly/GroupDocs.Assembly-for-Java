---
id: groupdocs-assembly-for-java-18-2-release-notes
url: assembly/java/groupdocs-assembly-for-java-18-2-release-notes
title: GroupDocs.Assembly for Java 18.2 Release Notes
weight: 7
description: ""
keywords: 
...
hideChildren: False
---
{{< alert style="info" >}}This page contains release notes for GroupDocs.Assembly for Java 18.2.{{< /alert >}}
...
{{< alert style="info" >}}This section lists public API changes that were introduced in GroupDocs.Assembly for Java 18.2. It includes not only new and obsoleted public methods, but also a description of any changes in the behaviour behind the scenes in GroupDocs.Assembly which may affect existing code. Any behaviour introduced that could be seen as a regression and modifies existing behaviour is especially important and is documented here.{{< /alert >}}
